...
class RolePermission(models.Model):
    ...
    function_master=models.ForeignKey(Function,related_name="function_permissions",on_delete=models.CASCADE,null=True)
    create=models.BooleanField(default=False)
    view=models.BooleanField(default=False)
    edit=models.BooleanField(default=False)
    delete=models.BooleanField(default=False)
    created_by=models.ForeignKey(User,related_name="permission_created_by",on_delete=models.CASCADE,null=True,blank=True)
